...
public enum ErrorCode {
  ...
  DUPLICATE_FORTUNE_TITLE(HttpStatus.CONFLICT, "📝 이미 동일한 이름의 운세가 저장되어 있습니다."),
  EXCEED_MAX_SAVE_COUNT(HttpStatus.FORBIDDEN, "💾 저장 가능한 운세 개수를 초과했습니다."),
  FORTUNE_CATEGORY_NOT_FOUND(HttpStatus.BAD_REQUEST, "🔍 일부 운세 카테고리를 찾을 수 없습니다."),
